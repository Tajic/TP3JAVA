...
public class inputProfDialog extends JDialog implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource()==this.okButton && this.nom.getText().length() != 0 && this.prenom.getText().length() != 0 && this.login.getText().length() != 0 && this.password.getText().length() != 0){
				this.professeur = new Professeur(this.nom.getText(), this.prenom.getText(), this.login.getText(), this.password.getText());
				this.dispose();
			}
